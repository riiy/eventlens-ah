...
# ---------------------------------------------------------------------------
# Seed Assets (22 equities covering A-share + HK markets, including acceptance
# test pack assets from eventlens_ah_acceptance_pack)
# ---------------------------------------------------------------------------

SEED_ASSETS: list[dict] = [
    # ── Original 10 demo assets ──────────────────────────────────────
    {
        "id": uuid4(),
        "symbol": "600519.SH",
        "name": "贵州茅台",
    ...
    # ── Acceptance pack A-share assets ────────────────────────────────
    {
        "id": uuid4(),
        "symbol": "600001.SH",
        "name": "智造光电",
    ...
    },
    {
        ...
        "sector": "计算机",
        "industry": "AI服务器",
        "business_tags": ["AI服务器", "GPU集群", "国产算力"],
        "metadata_json": {"is_demo_data": True},
    },
    {
        "id": uuid4(),
    ...
    },
    {
        ...
        "sector": "电子",
        "industry": "半导体设备",
        "business_tags": ["半导体设备", "国产替代", "先进封装"],
        "metadata_json": {"is_demo_data": True},
    },
    # ── Acceptance pack HK-share assets ───────────────────────────────
    {
        "id": uuid4(),
        "symbol": "09888.HK",
        "name": "港云智能",
    ...
    },
    {
        ...
        "sector": "医药",
        "industry": "创新药",
        "business_tags": ["创新药", "临床试验", "license-out"],
        "metadata_json": {"is_demo_data": True},
    },
    {
        "id": uuid4(),
