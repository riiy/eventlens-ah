...
class QwenProvider(BaseLLMProvider):
    ...
    NOTE: This is a stub implementation. Set QWEN_API_KEY in your environment
    ...
    def __init__(
        ...
        if not self.api_key:
            logger.warning(
                "QWEN_API_KEY is not set. QwenProvider will raise NotImplementedError "
                "until a valid API key is configured."
            )
    ...
    async def _call_api(
        ...
        Raises NotImplementedError until QWEN_API_KEY is configured.
        """
        if not self.api_key:
            raise NotImplementedError(
                "QWEN_API_KEY is not configured. Set the environment variable "
                "QWEN_API_KEY or add it to your .env file to use the Qwen provider. "
